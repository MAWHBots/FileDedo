...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://jacksparrow0982com:0fG8YhlJ1aVGANiC@cluster0.yzbfamz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "jacksparrow0982com")
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5324831370 6444128136 6350827518 7181228944").split()):
        ADMINS.append(int(x))
except ValueError:
